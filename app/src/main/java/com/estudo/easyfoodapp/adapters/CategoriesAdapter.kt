...
import com.estudo.easyfoodapp.databinding.CategoryItemBinding
import com.estudo.easyfoodapp.pojo.Category
...
class CategoriesAdapter(): RecyclerView.Adapter<CategoriesAdapter.CategoryViewHolder>() {
    ...
    fun setCaategoryList(categoriesList: List<Category>){
